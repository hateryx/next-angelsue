...
import { Accordion, AccordionSummary, AccordionDetails, Box, Button, Container, Grid, Typography, useMediaQuery, ShoppingBagOutlined } from "@mui/material";
...
function MainShopping() {
  ...
  return (
    <div className="w-full justify-center bg-white items-center">
      ...
      <Box container className="my-5 mx-auto md:px-20 items-center grid grid-cols-1 md:grid-cols-2 gap-4">
        <Box>
